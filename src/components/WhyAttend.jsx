        ...
        <div id="why-attend" className="bg-[#f2e7d1] flex flex-col gap-[64px] items-center pt-[96px] pb-24 relative shrink-0 w-full" data-name="4_Section_WhyFocus" data-node-id="11:665">
            ...
            <div className="hidden md:grid container mx-auto px-4 max-w-7xl grid-cols-1 md:grid-cols-3 gap-8 relative shrink-0 w-full" data-name="Container" data-node-id="11:671">
                {reasons.map((reason, index) => (
                    <div key={index} className={`bg-[#faf7f2] border-2 border-[${reason.borderColor}] border-solid flex flex-col gap-[24px] min-h-[335px] h-auto items-start pb-[2px] pt-[34px] px-[34px] relative rounded-[6px]`} style={{ borderColor: reason.borderColor }}>
