...
export default function FAQ() {
    ...
    return (
        <div id="faq" data-lenis-prevent="true" className="bg-[#faf7f2] flex flex-col items-center py-24 relative shrink-0 w-full" data-name="8_Section_FAQ" data-node-id="11:766">
