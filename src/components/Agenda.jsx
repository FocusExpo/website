...
export default function Agenda() {
    ...
    return (
        <div id="agenda" className="bg-[#faf7f2] flex flex-col gap-[64px] items-center pt-[96px] pb-24 relative shrink-0 w-full" data-name="6_Section_Agenda" data-node-id="11:701">
            <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-24 max-w-7xl flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Container" data-node-id="11:702">
