...
export default function CTA() {
    ...
    return (
        <div data-lenis-prevent="true" className="bg-[#f2e7d1] flex flex-col gap-[32px] items-center pt-[64px] pb-[96px] relative shrink-0 w-full overflow-hidden" data-name="9_Section_CTA" data-node-id="4:611">
