...
export default function Location() {
    return (
        <div id="location" data-lenis-prevent="true" className="bg-[#1c3d42] flex flex-col gap-16 min-h-[800px] items-center py-24 px-4 sm:px-6 md:px-12 lg:px-24 relative w-full overflow-hidden">
            {/* Background Image */}
