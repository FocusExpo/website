...
export default function Location() {
    return (
        <div className="bg-[#1c3d42] content-stretch flex flex-col gap-[64px] min-h-[900px] items-center pt-[96px] pb-24 px-4 relative shrink-0 w-full overflow-hidden" data-name="7_Section_Map" data-node-id="4:590">
            <div className="absolute h-full w-full left-0 top-0 pointer-events-none" data-name="Layer_10" data-node-id="7:103">
                <img alt="" className="block w-full h-full object-cover opacity-50" src={imgLayer11} />
            </div>
            <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0 w-full" data-name="Container" data-node-id="17:20">
                <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Container" data-node-id="17:21">
                ...
                <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Heading 2" data-node-id="17:23">
            ...
            <div className="content-stretch flex flex-col lg:flex-row gap-8 items-center justify-center relative shrink-0 w-full max-w-7xl" data-node-id="16:16">
                <div className="content-stretch flex flex-col gap-[8px] items-center lg:items-start relative shrink-0 w-full lg:w-auto" data-name="Container" data-node-id="4:593">
                ...
                <div className="border-8 border-[#e8eaed] border-solid flex-[1_0_0] relative rounded-[4px] self-stretch w-full min-h-[300px] lg:min-h-auto" data-name="image 2" data-node-id="16:18">
