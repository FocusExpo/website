    ...
    return (
        <div id="hero" data-lenis-prevent="true" className="bg-[#1c3d42] content-stretch flex flex-col gap-[40px] md:gap-[90px] min-h-screen items-center justify-center overflow-hidden py-[100px] md:py-[200px] relative shrink-0 w-full" data-name="1_Section_Hero" data-node-id="4:419">
            ...
            <div className="content-stretch flex flex-col gap-[30px] items-center justify-center relative shrink-0" data-node-id="16:3">
                <div className="content-stretch flex flex-col md:flex-row gap-[32px] items-center justify-center relative shrink-0 px-4 sm:px-6 md:px-12 lg:px-24" data-name="Container" data-node-id="4:522">
                    <div className="relative shrink-0 max-w-full py-8 flex justify-center" data-name="Layer_10" data-node-id="5:9">
                    ...
                    <div className="content-stretch flex flex-col gap-[34px] items-center md:items-start relative shrink-0 max-w-full" data-node-id="7:119">
                ...
                <div className="content-stretch flex flex-col gap-[24px] items-center justify-center relative shrink-0 w-full px-4 sm:px-6 md:px-12 lg:px-24" data-node-id="7:120">
                    ...
                    <a
                        ...
                        style={{ color: 'white' }}
                        className="bg-[#dd664e] hover:bg-[#c55842] text-white w-[280px] md:w-[340px] h-[54px] rounded-[4px] font-bold text-[14px] uppercase tracking-[1px] transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 flex items-center justify-center p-4 text-center mt-2"
                    >
                        Donate To Droplets Of Mercy
                    </a>
                </div>
            </div>
        </div>
